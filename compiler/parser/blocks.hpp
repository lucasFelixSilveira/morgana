...
struct block {
    ...
    /* Stack that stores the current constantes in the parsing context.
     *
     * Each block level contains a vector of (identifier, value),
     * representing declared constants within that scope. */
